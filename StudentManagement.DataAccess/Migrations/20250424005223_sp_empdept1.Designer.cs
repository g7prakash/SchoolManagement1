...
namespace StudentManagement.DataAccess.Migrations
{
    ...
    [Migration("20250424005223_sp_empdept1")]
    partial class sp_empdept1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.DataAccess.ViewModels.EmployeeDepartmentViewModel", b =>
                {
                    ...
                    b.ToTable("EmployeeDepartmentViewModel");
                });

            modelBuilder.Entity("StudentManagement.Models.Bike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tbl_bikes", (string)null);
                });

            modelBuilder.Entity("StudentManagement.Models.BikeCategory", b =>
                {
                    ...
                    b.ToTable("tbl_bike_categories", (string)null);
                });

            modelBuilder.Entity("StudentManagement.Models.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentManagement.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentManagement.Models.Bike", b =>
                {
                    b.HasOne("StudentManagement.Models.Brand", "Brand")
                        .WithMany("Bikes")
            ...
            modelBuilder.Entity("StudentManagement.Models.BikeCategory", b =>
                {
                    b.HasOne("StudentManagement.Models.Bike", "Bike")
                        .WithMany("BikeCategories")
                        .HasForeignKey("BikeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudentManagement.Models.Category", "Category")
                        .WithMany("BikeCategories")
